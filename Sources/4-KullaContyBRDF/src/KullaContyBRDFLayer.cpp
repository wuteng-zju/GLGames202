...
KullaContyBRDFLayer::KullaContyBRDFLayer() :
	Layer("SandBox"),
...
void KullaContyBRDFLayer::OnAttach()
{
	Render::Init();
...
void KullaContyBRDFLayer::OnDetach()
{
}

void KullaContyBRDFLayer::OnUpdate(const TimeStep& ts)
{
...
void KullaContyBRDFLayer::OnImGuiRender()
{
...
void KullaContyBRDFLayer::OnEvent(Event& event)
{
