...
void ShadowMapLayer::OnDetach()
{
}

void ShadowMapLayer::OnUpdate(const TimeStep& ts)
{
...
void ShadowMapLayer::OnImGuiRender()
{
...
void ShadowMapLayer::OnEvent(Event& event)
{
