...
{
	return CreateRef<FrameBuffer>(spFrameBufferSpecification);
}
...
namespace
{
	...
	bool IsDepthFormat(FramebufferTextureFormat format)
	{
		switch (format)
		{
		case GLCore::FramebufferTextureFormat::DEPTH24_STENCIL8:
			return true;
		}
		return false;
	}
	...
	GLenum TextureFormatToGL(FramebufferTextureFormat format)
	{
		switch (format)
		{
		case GLCore::FramebufferTextureFormat::RED_INTERGER:
			return GL_RED_INTEGER;
		case GLCore::FramebufferTextureFormat::RGBA8:
			return GL_RGBA8;
		}
		return 0;
	}
...
FrameBuffer::FrameBuffer(const Ref<FrameBufferSpecification>& spFrameBufferSpecification) :
	m_spFrameBufferSpecification(spFrameBufferSpecification), 
	m_uiRenderID(0)
{
...
int FrameBuffer::ReadPixel(unsigned int uiIndex, unsigned int uiX, unsigned int uiY) const
{
...
void FrameBuffer::ClearColorAttachment(unsigned int uiIndex, int iValue) const
{
...
void FrameBuffer::Resize(unsigned int uiWidth, unsigned int uiHeight)
{
